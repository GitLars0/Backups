...
protected override void OnModelCreating(ModelBuilder modelBuilder)
{
		...
		modelBuilder.Entity<Order>().HasOne(o => o.Customer).WithMany().HasForeignKey("CustomerId");
		modelBuilder.Entity<Order>().OwnsOne(o => o.Location);

		 modelBuilder.Entity<Invoice>().HasOne(o => o.Customer).WithMany().HasForeignKey("CustomerId");
		 modelBuilder.Entity<Invoice>().OwnsOne(o => o.Address);
 }
...
internal class FakeData
{
	...
	internal static void Init()
	{
		...
		FoodItems = Enumerable.Range(1, 30).Select(i =>
			{
				var item = new FoodItem(lorem.Sentence(3, 2), lorem.Sentence(10, 10), random.Decimal(50,250)+.99m)
				{
